...
export default function Challenge() {
  return (
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
      ...
      <UserCard name="Jon"  role="Software Engineer"        emoji="🎮"></UserCard>
      <UserCard name="Rob"  role="Financial Analyst"        emoji="♾️"></UserCard>
      <UserCard name="Andy" role="Senior Software Engineer" emoji="💻"></UserCard>
    </div>
  )
}
